...
async def get_waste_categories(db=Depends(get_db)):
    ...
    try:
        ...
        categories = []
        for row in rows:
            categories.append(WasteCategory(
...
async def get_recycling_opportunities(
    ...
    try:
        ...
        opportunities = []
        for row in rows:
            opportunities.append(RecyclingOpportunity(
...
async def get_pollution_prevention_opportunities(
    ...
    try:
        ...
        opportunities = []
        for row in rows:
            opportunities.append(PollutionPreventionOpportunity(
                opportunity_id=row[0],
                task_name=row[1],
...
async def get_task_waste_relationships(
    task_name: Optional[str] = None,
    db=Depends(get_db)
):
    ...
    try:
        ...
        relationships = []
        for row in rows:
            relationships.append(TaskWasteRelationship(
                task_name=row[0],
                waste_category_id=row[1],
                average_quantity_kg=row[2],
                frequency=row[3]
            ))
